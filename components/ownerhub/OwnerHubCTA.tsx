...
import { ArrowRight, ShieldCheck, Layers, FileText } from 'lucide-react'

const pillars = [
  { icon: ShieldCheck, text: 'Fully Auditable Settlements' },
  { icon: Layers, text: '8 Distribution Models' },
  { icon: FileText, text: 'Self-Service Statements' },
]

export default function OwnerHubCTA() {
  return (
        ...
        <AnimatedSection direction="up">
          <div className="relative bg-stayguide-blue-dark rounded-3xl p-10 md:p-16 text-center overflow-hidden">
            <svg className="absolute inset-0 w-full h-full opacity-[0.05] pointer-events-none" xmlns="http://www.w3.org/2000/svg">
              <filter id="ownerhub-cta-noise">
                <feTurbulence type="fractalNoise" baseFrequency="0.9" numOctaves="2" stitchTiles="stitch" />
              </filter>
              <rect width="100%" height="100%" filter="url(#ownerhub-cta-noise)" />
            </svg>
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-white font-heading mb-6">
                Ready to End Settlement Disputes?
              </h2>
              <p className="text-lg leading-8 text-white/75 mb-10">
                See how OwnerHub turns owner payouts from a monthly scramble into an
                automatic, transparent process your owners actually trust.
              </p>
